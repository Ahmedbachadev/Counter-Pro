...
const Settings: React.FC = () => {
  ...
  const navigationItems = [
    ...
    { id: 'pos', label: 'POS Defaults', icon: LayoutGrid },
    { id: 'staff', label: 'Staff Management', icon: Users },
    { id: 'notifications', label: 'Notifications Preferences', icon: Bell },
    { id: 'backup', label: 'Backup & Restore', icon: Database },
    { id: 'data', label: 'Data Management', icon: ShieldAlert },
    { id: 'actions', label: 'Quick Actions', icon: Sparkles },
    { id: 'database', label: 'Database Config', icon: Shield }
  ].filter(item => {
    if (item.id === 'staff') {
            ...
            {activeTab === 'profile' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-gray-300 uppercase tracking-wider mb-2">
                      Business Name (Urdu / Local)
                    </label>
                    <input
                      type="text"
                      value={formState.nameUrdu}
                      onChange={(e) => handleInputChange('nameUrdu', e.target.value)}
                      className="w-full px-4 py-2.5 border border-slate-300/80 dark:border-gray-700 bg-white dark:bg-gray-900 text-slate-950 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition text-right font-medium"
                      required
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-gray-300 uppercase tracking-wider mb-2">
                      Physical Address (Urdu)
                    </label>
                    <textarea
                      value={formState.addressUrdu}
                      onChange={(e) => handleInputChange('addressUrdu', e.target.value)}
                      rows={3}
                      className="w-full px-4 py-2.5 border border-slate-300/80 dark:border-gray-700 bg-white dark:bg-gray-900 text-slate-950 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition text-right font-medium"
                      required
                    />
            ...
            {activeTab === 'branding' && (
              <div className="space-y-6">
                <div className="border-b border-slate-100 dark:border-gray-700/60 pb-4">
                  ...
                  <p className="text-slate-500 dark:text-gray-400 text-xs mt-1">
                    White-label ready configurations. Upload logos and customize design tokens.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-gray-300 uppercase tracking-wider mb-2">
                      Invoice Logo URL or Base64
                    </label>
                    <input
                      type="text"
                      value={formState.invoiceLogo || ''}
                      onChange={(e) => handleInputChange('invoiceLogo', e.target.value)}
                      placeholder="Logo for PDF Invoices"
                      className="w-full px-4 py-2.5 border border-slate-300/80 dark:border-gray-700 bg-white dark:bg-gray-900 text-slate-950 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"
                    />
                  </div>
                ...
                <div className="bg-slate-50 dark:bg-gray-900/50 p-5 rounded-2xl border border-slate-200/50 dark:border-gray-800 space-y-4">
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white">Business UI Colors</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                      <label className="block text-xs font-semibold text-slate-600 dark:text-gray-300 uppercase tracking-wider mb-1.5">
                        Primary Color
                      </label>
                      <div className="flex items-center space-x-2">
                        ...
                        <input
                          ...
                          value={formState.primaryColor || '#2563eb'}
                          onChange={(e) => handleInputChange('primaryColor', e.target.value)}
                          className="w-24 px-2 py-1.5 border border-slate-300/80 dark:border-gray-700 bg-white dark:bg-gray-900 text-slate-950 dark:text-white rounded-lg text-sm"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          type="color"
                          value={formState.secondaryColor || '#4f46e5'}
              ...
              <div className="space-y-6">
                <div className="border-b border-slate-100 dark:border-gray-700/60 pb-4">
                  <h2 className="text-xl font-bold text-slate-950 dark:text-white flex items-center gap-2">
                    ...
                    POS Defaults & Preferences
                  </h2>
                  <p className="text-slate-500 dark:text-gray-400 text-xs mt-1">
                    Set cashier defaults, cash drawer connection patterns, and discount actions.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  <div>
                    ...
                    <select
                      value={formState.defaultPaymentMethod || 'cash'}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formState.defaultCustomerType || 'Walk-in'}
                      onChange={(e) => handleInputChange('defaultCustomerType', e.target.value)}
                  ...
                  <div>
                    ...
                    <select
                      value={formState.defaultDiscountBehavior || 'percentage'}
                      onChange={(e) => handleInputChange('defaultDiscountBehavior', e.target.value)}
                      className="w-full px-4 py-2.5 border border-slate-300/80 dark:border-gray-700 bg-white dark:bg-gray-900 text-slate-950 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"
                    >
                      <option value="percentage">Percentage (e.g. 10%)</option>
                      <option value="fixed">Fixed Currency Amount (e.g. 150 PKR)</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-3">
                  <label className="flex items-center justify-between p-4 bg-slate-50 dark:bg-gray-950/40 border border-slate-200/60 dark:border-gray-800 rounded-2xl cursor-pointer hover:bg-slate-100/50 dark:hover:bg-gray-900/60 transition">
                    <div>
                      <p className="font-bold text-sm text-slate-900 dark:text-white">Auto Print POS Receipt</p>
                      <p className="text-xs text-slate-400 dark:text-gray-500 mt-0.5">Enabling this immediately triggers receipt print upon finalizing POS sale.</p>
                    </div>
                    <input
                      type="checkbox"
                      checked={formState.autoPrintReceiptPOS}
                      onChange={(e) => handleInputChange('autoPrintReceiptPOS', e.target.checked)}
                      className="h-5.5 w-5.5 text-blue-600 focus:ring-blue-500 rounded-md"
                    />
                  </label>
                  ...
                  <label className="flex items-center justify-between p-4 bg-slate-50 dark:bg-gray-950/40 border border-slate-200/60 dark:border-gray-800 rounded-2xl cursor-pointer hover:bg-slate-100/50 dark:hover:bg-gray-900/60 transition">
                    <div>
                      <p className="font-bold text-sm text-slate-900 dark:text-white">Open Cash Drawer (Future-Ready)</p>
                      <p className="text-xs text-slate-400 dark:text-gray-500 mt-0.5">Sends kickout pulse to thermal printer RJ12 port on final payment.</p>
                    </div>
                    <input
                      type="checkbox"
                      checked={formState.openCashDrawer}
                      onChange={(e) => handleInputChange('openCashDrawer', e.target.checked)}
                      className="h-5.5 w-5.5 text-blue-600 focus:ring-blue-500 rounded-md"
                    />
                  </label>
                </div>
              ...
              <div className="space-y-6">
                <div className="border-b border-slate-100 dark:border-gray-700/60 pb-4">
                  <h2 className="text-xl font-bold text-rose-600 dark:text-rose-400 flex items-center gap-2">
                    ...
                    Destructive Actions Center
                  </h2>
                  <p className="text-slate-500 dark:text-gray-400 text-xs mt-1">
                    Purge business transaction history, delete products list, or seed fresh sample dataset.
                  </p>
                </div>

                <div className="space-y-4">
                  {/* Purge Demo Data Card */}
                  <div className="p-5 border border-rose-200/60 dark:border-rose-950/60 rounded-2xl bg-rose-50/30 dark:bg-rose-950/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div className="space-y-1">
                      <p className="font-bold text-slate-900 dark:text-white text-sm">Purge All Workspace Data</p>
                      <p className="text-xs text-slate-500 dark:text-gray-400 max-w-xl">
                        Deletes every transaction record, inventory log, registered customer, and expense. Does not reset settings profile. <strong>This action is irreversible.</strong>
                      </p>
                    </div>
                    {showClearConfirm ? (
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          ...
                          className="px-3.5 py-1.5 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold rounded-lg text-xs"
                        >
                          Cancel
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-rose-500/10 hover:bg-rose-500/20 text-rose-600 dark:text-rose-400 font-bold rounded-xl text-xs border border-rose-200 dark:border-rose-900 transition shrink-0"
                      >
                        Purge Data
                      </button>
                    )}
                  ...
                  <div className="p-5 border border-blue-200/60 dark:border-blue-950/60 rounded-2xl bg-blue-50/20 dark:bg-blue-950/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div className="space-y-1">
                      <p className="font-bold text-slate-900 dark:text-white text-sm">Reset & Seed Sample Catalog</p>
                      <p className="text-xs text-slate-500 dark:text-gray-400 max-w-xl">
                        Purges current state and writes demo items (categories, suppliers, basic inventory, sample sales). Perfect for diagnostic validation.
                      </p>
                    </div>
                    {showResetConfirm ? (
                      <div className="flex items-center space-x-2">
                        <button
                          type="button"
                          onClick={triggerResetSampleData}
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-blue-500/10 hover:bg-blue-500/20 text-blue-600 dark:text-blue-400 font-bold rounded-xl text-xs border border-blue-200 dark:border-blue-900 transition shrink-0"
                      >
                        Seed Sample Dataset
                      </button>
                    )}
            ...
            {activeTab === 'actions' && (
              <div className="space-y-6">
                <div className="border-b border-slate-100 dark:border-gray-700/60 pb-4">
                  ...
                  <p className="text-slate-500 dark:text-gray-400 text-xs mt-1">
                    One-click operations for config exports, imports, and system adjustments.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  <button
                    type="button"
                    onClick={triggerExportBackup}
                    className="p-5 bg-slate-50 dark:bg-gray-950/40 border border-slate-200/80 dark:border-gray-800 rounded-2xl text-left hover:border-blue-500 dark:hover:border-blue-500 transition group"
                  >
                    <ArrowUpRight className="h-6 w-6 text-blue-500 mb-3 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                    <p className="font-bold text-sm text-slate-900 dark:text-white">Backup Now</p>
                    <p className="text-xs text-slate-400 dark:text-gray-500 mt-1">Export full local storage database.</p>
                  </button>

                  <label className="p-5 bg-slate-50 dark:bg-gray-950/40 border border-slate-200/80 dark:border-gray-800 rounded-2xl text-left hover:border-emerald-500 dark:hover:border-emerald-500 transition cursor-pointer group block">
                    <ArrowDownLeft className="h-6 w-6 text-emerald-500 mb-3 group-hover:-translate-x-0.5 group-hover:translate-y-0.5 transition-transform" />
                    <p className="font-bold text-sm text-slate-900 dark:text-white">Restore Data</p>
                    <p className="text-xs text-slate-400 dark:text-gray-500 mt-1">Import full database file.</p>
                    <input
                      type="file"
                      accept=".json"
                      onChange={handleImportBackup}
                  ...
                  <button
                    type="button"
                    onClick={triggerExportSettings}
                    className="p-5 bg-slate-50 dark:bg-gray-950/40 border border-slate-200/80 dark:border-gray-800 rounded-2xl text-left hover:border-indigo-500 dark:hover:border-indigo-500 transition group"
                  >
                    <FileText className="h-6 w-6 text-indigo-500 mb-3" />
                    <p className="font-bold text-sm text-slate-900 dark:text-white">Export Settings Only</p>
                    <p className="text-xs text-slate-400 dark:text-gray-500 mt-1">Backup only business rules & logos.</p>
                  </button>

                  <label className="p-5 bg-slate-50 dark:bg-gray-950/40 border border-slate-200/80 dark:border-gray-800 rounded-2xl text-left hover:border-indigo-500 dark:hover:border-indigo-500 transition cursor-pointer group block">
                    <Plus className="h-6 w-6 text-purple-500 mb-3" />
                    <p className="font-bold text-sm text-slate-900 dark:text-white">Import Settings Only</p>
                    <p className="text-xs text-slate-400 dark:text-gray-500 mt-1">Restore rules without clearing stock database.</p>
                    <input
                      type="file"
                      accept=".json"
                  ...
                  <div className="p-5 bg-slate-50 dark:bg-gray-950/40 border border-slate-200/80 dark:border-gray-800 rounded-2xl text-left hover:border-orange-500 dark:hover:border-orange-500 transition group flex flex-col justify-between">
                    <div>
                      <AlertTriangle className="h-6 w-6 text-orange-500 mb-3" />
                      <p className="font-bold text-sm text-slate-900 dark:text-white">Reset Preferences</p>
                      <p className="text-xs text-slate-400 dark:text-gray-500 mt-1">Revert rule configurations back to defaults.</p>
                    </div>
                    {showPrefConfirm ? (
                      <div className="flex items-center space-x-2 mt-3">
                        <button
                          type="button"
                          onClick={triggerResetPreferences}
                          className="px-3 py-1 bg-orange-600 text-white font-bold rounded-lg text-xs"
                        >
                          Confirm Reset
                        </button>
                        <button
                          type="button"
                          onClick={() => setShowPrefConfirm(false)}
                          className="px-3 py-1 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold rounded-lg text-xs"
                        >
                          Cancel
                        </button>
                      </div>
                      ...
                      <button
                        type="button"
                        onClick={() => setShowPrefConfirm(true)}
                        className="mt-3 py-1.5 w-full bg-orange-500/10 text-orange-600 dark:text-orange-400 font-bold rounded-xl text-xs border border-orange-200 dark:border-orange-900 transition"
                      >
                        Reset Defaults
                      </button>
                    )}
              ...
              <div className="space-y-6">
                <div className="border-b border-slate-100 dark:border-gray-700/60 pb-4">
                  <h2 className="text-xl font-bold text-slate-950 dark:text-white flex items-center gap-2">
                    ...
                    Database Selection & Sync
                  </h2>
                  <p className="text-slate-500 dark:text-gray-400 text-xs mt-1">
                    Select the active data repository driver: SQLite local database or HTML LocalStorage container.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <button
                    ...
                    className={`flex items-start p-5 border-2 rounded-2xl text-left transition-all ${
                      currentDbType === 'sqlite'
                        ? 'border-blue-500 bg-blue-50/20 dark:bg-blue-950/30'
                        : 'border-slate-200 dark:border-gray-800 hover:border-blue-300'
                    }`}
                  >
                    <div className="bg-blue-500 p-2.5 rounded-xl text-white mr-4 shrink-0 shadow-md shadow-blue-500/10">
                      <Database className="h-5 w-5" />
                    </div>
                    <div>
                      <p className="font-bold text-slate-900 dark:text-white text-sm">SQLite Local Database</p>
                      <p className="text-xs text-slate-400 dark:text-gray-500 mt-1">
                        High performance SQLite engine running inside native Electron boundaries.
                      </p>
                    </div>
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={() => handleDatabaseSwitch('json')}
                    className={`flex items-start p-5 border-2 rounded-2xl text-left transition-all ${
                      currentDbType === 'json'
                        ? 'border-blue-500 bg-blue-50/20 dark:bg-blue-950/30'
                        : 'border-slate-200 dark:border-gray-800 hover:border-blue-300'
                  ...
                  >
                    <div className="bg-emerald-500 p-2.5 rounded-xl text-white mr-4 shrink-0 shadow-md shadow-emerald-500/10">
                      <LayoutGrid className="h-5 w-5" />
                    </div>
                    <div>
                      <p className="font-bold text-slate-900 dark:text-white text-sm">JSON LocalStorage</p>
                      <p className="text-xs text-slate-400 dark:text-gray-500 mt-1">
                        Lightweight sandboxed client storage inside the web browser sandbox.
                      </p>
                    </div>
                  </button>
                </div>
                ...
                {currentDbType === 'sqlite' && (
                  <div className="pt-4 border-t border-slate-100 dark:border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div>
                      <p className="font-bold text-slate-900 dark:text-white text-sm">SQLite to LocalStorage Sync</p>
                      <p className="text-xs text-slate-400 dark:text-gray-500 mt-0.5">
                        Creates an emergency backup copy of SQLite data in browser storage context.
                      </p>
                    </div>
                    <button
                      type="button"
